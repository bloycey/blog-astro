...
<iframe class="video" src="https://www.youtube.com/embed/dsTXcSeAZq8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
Don't fancy reading the full blog post? Just watch the clip above for a brilliant overview of Astro.
...
The real magic, however, comes from the [islands](https://docs.astro.build/en/concepts/islands/) architecture.
